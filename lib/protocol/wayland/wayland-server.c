...
import wayland-util;
import wayland-private;
import wayland-server-private;
...
WlDisplay {
    ...
    WlList registry_resource_list;
    WlList global_list;
    WlList socket_list;
    WlList client_list;
    WlList protocol_loggers;
...
static i32 debug_server = 0;

static void
log_closure(struct wl_resource *resource,
        struct wl_closure *closure, i32 send)
{
    struct wl_object *object = &resource->object;
    WlDisplay *display = resource->client->display;
...
handle_array(struct wl_resource *resource, uint32_t opcode,
         union wl_argument *args,
         i32 (*send_func)(struct wl_closure *, struct wl_connection *))
{
...
static i32
wl_client_connection_data(i32 fd, uint32_t mask, void *data)
{
...
static i32
bind_display(struct wl_client *client, WlDisplay *display);
...
WL_EXPORT struct wl_resource *
wl_resource_from_link(WlList *link)
{
    struct wl_resource *resource;
...
WL_EXPORT struct wl_resource *
wl_resource_find_for_client(WlList *list, struct wl_client *client)
{
    struct wl_resource *resource;
...
{
    WlDisplay *display = client->display;
          ...
          const char *interface, uint32_t version, uint32_t id)
{
    ...
    WlDisplay *display = resource->data;
...
static const WlDisplay_interface display_interface = {
    display_sync,
...
static i32
handle_display_terminate(i32 fd, uint32_t mask, void *data) {
    uint64_t term_event;
...
////
WL_EXPORT void
wl_display_destroy(WlDisplay *display)
{
...
////
WL_EXPORT void
wl_display_set_global_filter(WlDisplay *display,
...
wl_global_create(WlDisplay *display,
         const WlInterface *interface, i32 version,
...
{
    WlDisplay *display = global->display;
    struct wl_resource *resource;
...
////
WL_EXPORT uint32_t
wl_display_get_serial(WlDisplay *display)
{
...
////
WL_EXPORT uint32_t
wl_display_next_serial(WlDisplay *display)
{
    display->serial++;
...
wl_display_get_event_loop(WlDisplay *display)
{
    return display->loop;
}

WL_EXPORT void
wl_display_terminate(WlDisplay *display)
{
    i32 ret;
...
WL_EXPORT void
wl_display_run(WlDisplay *display)
{
    display->run = 1;
...
WL_EXPORT void
wl_display_flush_clients(WlDisplay *display)
{
...
////
WL_EXPORT void
wl_display_destroy_clients(WlDisplay *display)
{
    WlList tmp_client_list, *pos;
    struct wl_client *client;
...
static i32
socket_data(i32 fd, uint32_t mask, void *data)
{
    WlDisplay *display = data;
...
wl_socket_init_for_display_name(struct wl_socket *s, const char *name)
{
    ...
    assert(name_size > 0);
    if (name_size > (i32)sizeof s->addr.sun_path) {
...
static i32
_wl_display_add_socket(WlDisplay *display, struct wl_socket *s)
{
    socklen_t size;
...
WL_EXPORT const char *
wl_display_add_socket_auto(WlDisplay *display)
{
    struct wl_socket *s;
    i32 displayno = 0;
...
////
WL_EXPORT i32
wl_display_add_socket_fd(WlDisplay *display, i32 sock_fd)
{
    struct wl_socket *s;
    struct stat buf;
...
////
WL_EXPORT i32
wl_display_add_socket(WlDisplay *display, const char *name)
{
    struct wl_socket *s;
...
WL_EXPORT void
wl_display_add_destroy_listener(WlDisplay *display,
                WlListener *listener)
{
...
////
WL_EXPORT void
wl_display_add_client_created_listener(WlDisplay *display,
                    WlListener *listener)
{
...
WL_EXPORT WlListener *
wl_display_get_destroy_listener(WlDisplay *display,
                wl_notify_func_t notify)
{
...
wl_display_add_protocol_logger(WlDisplay *display,
...
////
WL_EXPORT uint32_t *
wl_display_add_shm_format(WlDisplay *display, uint32_t format)
{
    uint32_t *p = null;
...
////
struct wl_array *
wl_display_get_additional_shm_formats(WlDisplay *display)
{
...
////
WL_EXPORT WlList *
wl_display_get_client_list(WlDisplay *display)
{
...
static void
handle_noop(WlListener *listener, void *data)
{
    /* Do nothing */
}
...
wl_signal_emit_mutable(struct wl_signal *signal, void *data)
{
    ...
    while (cursor.link.next != &end.link) {
        WlList *pos = cursor.link.next;
        WlListener *l = wl_container_of(pos, l, link);
...
////
void
wl_priv_signal_add(struct wl_priv_signal *signal, WlListener *listener)
{
...
struct wl_global *
wl_display_add_global(WlDisplay *display,
              const WlInterface *interface,
...
void
wl_display_remove_global(WlDisplay *display,
             struct wl_global *global) WL_DEPRECATED;

WL_EXPORT void
wl_display_remove_global(WlDisplay *display, struct wl_global *global)
{
